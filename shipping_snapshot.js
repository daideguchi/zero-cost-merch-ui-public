window.ZERO_COST_SHIPPING_BOARD = {
  "generated_at": "2026-04-30 00:06:46 JST",
  ...
  "last_monitor": {
    "checked_at": "2026-04-30 00:03:56 JST",
    "orders_count": 0,
    "new_orders_count": 0,
  ...
  "readiness": [
    ...
    },
    {
      ...
      "label": "同期ヘルス",
      "progress": 8,
      "summary": "同期古め / shipping render は通っていますが、post-sale sync の最終成功が古いです。"
    },
    {
  ...
  "next_actions": [
    ...
    "API整備: Yahoo!ショッピング / YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID を入れ、ストア配送優先で最初の1件を閉じる。",
    ...
    "exceptions": [
      {
        "severity": "yellow",
        "label": "Yahoo!ショッピング",
        "detail": "本線では待たない: OAuth と token bundle は取得済み。初回の売却後フローは Yahoo!ショッピング標準のストア配送を優先し、Ship&co は後段の共通化候補として扱う。"
      },
      {
        "severity": "orange",
    ...
    "supporting_panels": [
      ...
      },
      {
        ...
        "items": [
          ...
          "BASE: 出品=refresh_token / 発送=BASE標準 かんたん発送 / 状態=order_waiting / 次=BASE実注文 1件で 注文画面 -> 集荷 -> 発送完了 を証跡化する",
          "Yahoo!ショッピング: 出品=seller/business設定待ち / 発送=Yahoo!ショッピング ストア配送 + ヤマト集荷 / 状態=seller/business設定待ち / 次=YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID を入れ、ストア配送優先で最初の1件を閉じる。"
        ]
      },
      {
        "label": "入口",
        "items": [
          "resident: https://macbook-pro-m4.tail8c523e.ts.net:8447/merch/zero-cost/shipping.html",
  ...
  "api_readiness": {
    ...
    "summary": {
      ...
      "detail": "メルカリは メルカリBiz配送 + 送り状印刷 + ヤマト集荷、BASEは BASE標準 かんたん発送、Yahoo!ショッピングは Yahoo!ショッピング ストア配送 + ヤマト集荷 で進めます。待たないもの: YBM For Developers 返信 / Ship&co 国内 carrier 設定 / Ship&co API の live orders 疎通。",
      "unresolved": 3,
      "mainline_blockers": 0,
      "optional_blockers": 3
    },
    "items": [
      ...
      },
      {
        ...
        "detail": "BOX-001-ITEM-0002 published"
      },
      {
      ...
      },
      {
        ...
        "progress": 6,
        "status": "seller/business設定待ち",
        "summary": "OAuth と token bundle は取得済み。初回の売却後フローは Yahoo!ショッピング標準のストア配送を優先し、Ship&co は後段の共通化候補として扱う。",
        "detail": "YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID を入れ、ストア配送優先で最初の1件を閉じる。"
      },
      {
    ...
    "stoplines": [
      {
        ...
        "message": "OAuth と token bundle は取得済み。初回の売却後フローは Yahoo!ショッピング標準のストア配送を優先し、Ship&co は後段の共通化候補として扱う。",
        "next_action": "YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID を入れ、ストア配送優先で最初の1件を閉じる。"
      },
      {
        "severity": "orange",
  ...
  "print_exports": {
    ...
    "download_ready": true,
    "filenames": {
      "json": "shipping_print_packets_20260430_000646.json",
      "shipment_csv": "shipping_print_packets_20260430_000646.csv",
      "batch_csv": "shipping_pickup_batches_20260430_000646.csv"
    }
  },
  "capture_contract": {
  ...
  "channel_statuses": [
    {
      ...
      "post_sale_status": "monitor 2026-04-30 00:03:56 JST / orders=0",
    ...
    },
    {
      "id": "yahoo_shopping",
      "label": "Yahoo!ショッピング",
      "publish_status": "seller/business設定待ち",
      "shipping_lane": "Yahoo!ショッピング ストア配送 + ヤマト集荷",
      "fulfillment_status": "seller/business設定待ち",
      "post_sale_status": "OAuth と token bundle は取得済み。初回の売却後フローは Yahoo!ショッピング標準のストア配送を優先し、Ship&co は後段の共通化候補として扱う。",
      "proof_status": "受注 0件 / ストア配送未実証",
      "next_action": "YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID を入れ、ストア配送優先で最初の1件を閉じる。",
      "blocker": "YAHOO_SHOPPING_SELLER_ID / YAHOO_SHOPPING_BUSINESS_ID"
    }
  ],
  "sync_health": {
    "checked_at": "2026-04-30 00:06:46 JST",
    "status": "ok",
    "badge": "同期古め",
    "headline": "shipping render は通っていますが、post-sale sync の最終成功が古いです。",
    "detail": "post-sale sync の最終成功が 188時間前です。",
    "next_action": "sync_post_sale_flow.py と render_shipping_board.py を再実行して current truth を更新する",
    "fallback_in_use": false,
    "last_success_generated_at": "2026-04-30 00:06:46 JST",
    "last_success_at": "2026-04-22 03:17:44 JST",
    "last_run_duration_ms": 9564,
    "duration_label": "9.6s",
    "stale_reason": "post-sale sync の最終成功が 188時間前です。",
    "source_fetches": [
      {
        "label": "09_受注一覧",
    ...
    "failed_sources": [],
    "monitor": {
      "checked_at": "2026-04-29T15:03:56.115Z",
      "orders_count": 0,
      "new_orders_count": 0,
      "next_action": "No new orders detected."
    },
