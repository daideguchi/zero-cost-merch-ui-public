window.ZERO_COST_STATUS = {
  "generated_at": "2026-04-21 16:45:19 JST",
  ...
  "api_lane": {
    ...
    "note": "published_product=PRD-BOX-001-032 / listingId=2JPTBkWndxGku2L9EVw4UP / image_refreshed=10 / cosmetics_applicationId=2zpKKFVRC4aUXzG6o / 公開済み10件へ public image asset を再投入し、出品画像の基本は実物へ更新済み。比較画像は resident の照合用で、100%同一確認済みのものだけ出品画像に使う。 / Bearer /v1/graphql は 2026-04-11 のメルカリShops返信で連携見送り確定"
  },
  "strategy": {
